...
<%
    ...
    // 해당 회원의 정보를 db에서 가져옴
    try {
        String sql = "select * from board_stu where lev=0 order by resdate desc";
...
<div class="wrap">
    ...
    <div class="contents" id="contents">
        <div class="breadcrumb">
            <p><a href="/">HOME</a> &gt; <a href="boardStuList.jsp">학생게시판</a></p>
        </div>
            ...
            <div class="page_wrap">
                ...
                <table class="tb1" id="myTable">
                    ...
                    <tr>
                        ...
                        <td class="item2"><a href="getBoardStu.jsp?bno=<%=arr.getBno() %>"><%=arr.getTitle() %></a></td>
