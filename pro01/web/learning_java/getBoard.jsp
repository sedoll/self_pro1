...
<%
    ...
    try{
        // 조회수 갱신 코드
        conn = con.connect();
        String sql = "update board_java set cnt=cnt+1 where bno=?";
        ...
        String sql2 = "select * from board_java where bno=?";
...
<div class="wrap">
    ...
    <div class="contents" id="contents">
        <div class="breadcrumb">
            <p><a href="/">HOME</a> &gt; <a href="boardList.jsp">자바</a> &gt; <a href="getBoard.jsp?bno=<%=bno%>">게시글 상세</a></p>
        </div>
                ...
                <table class="tb1">
                    ...
                    <tr>
                        <td colspan="5" class="hl">
                            <div>
                                <a class="move-on" href="<%=boardList.get(0).getLink()%>" target="_blank">사이트 이동</a>
                            </div>
                        </td>
                    </tr>
                    </tbody>
