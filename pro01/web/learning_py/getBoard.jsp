...
<%
    ...
    try{
        // 조회수 갱신 코드
        conn = con.connect();
        String sql = "update board_py set cnt=cnt+1 where bno=?";
        ...
        String sql2 = "select * from board_py where bno=?";
...
<div class="wrap">
    ...
    <div class="contents" id="contents">
        <div class="breadcrumb">
            <p><a href="/">HOME</a> &gt; <a href="boardList.jsp">파이썬</a> &gt; <a href="getBoard.jsp?bno=<%=bno%>">게시글</a></p>
        </div>
